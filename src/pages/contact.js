...
/>
    ...
    <div className="min-h-screen pt-24">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-8">
                ...
                Our team is ready to assist you from our office in Accra.
              </p>
              ...
              <div className="space-y-8 mb-10">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Proudly serving Accra and surrounding areas</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-green-600 font-medium mt-1">24/7 Emergency Service Available</p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  <a href="#" className="bg-gray-200 hover:bg-green-100 rounded-full p-3 transition-colors">
                ...
                <form className="space-y-6" onSubmit={handleSubmit} id="contact-form">
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      id="address" 
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors" 
                      placeholder="Your Address in Ghana"
                      required
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="renewable">Solar Energy Solutions</option>
                  ...
                  <div className="flex items-start">
                    <input 
                      id="privacy" 
                      type="checkbox" 
                      className="h-5 w-5 mt-1 text-green-500 border-gray-300 rounded focus:ring-green-500" 
                      required
                      checked={formData.privacyConsent}
                      onChange={handleInputChange}
                    />
                    <label htmlFor="privacy" className="ml-3 text-sm text-gray-600">
                      I agree to the <Link href="/privacy-policy" className="text-green-500 hover:underline">Privacy Policy</Link> and consent to my data being processed.
                    </label>
                  </div>
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    type="submit"
                    className="w-full bg-green-500 hover:bg-green-600 text-white font-medium py-3 px-6 rounded-lg shadow-md transition-all duration-300 flex justify-center items-center"
      ...
      <section className="py-12 bg-green-500 animate-on-scroll">
        <div className="container mx-auto px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0 }}
          ...
          >
            <div className="flex items-center mb-6 md:mb-0">
              ...
              <div>
                ...
                <p className="text-white/90">Available across Ghana for urgent electrical needs</p>
              </div>
            </div>
      ...
      <section className="py-16 animate-on-scroll">
        <div className="container mx-auto px-6 lg:px-8">
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.7 }}
            className="bg-gradient-to-r from-blue-600 to-green-500 rounded-2xl p-8 md:p-12 text-center text-white shadow-xl"
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Get Started?</h2>
            <p className="text-xl text-white/90 max-w-2xl mx-auto mb-8">
              Contact our team today for expert electrical services and solar solutions across Ghana
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a 
                href="#contact-form" 
                className="bg-green-600 hover:bg-green-700 text-white font-medium px-8 py-3 rounded-lg transition-colors flex items-center justify-center"
              >
