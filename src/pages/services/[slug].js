...
import { ArrowLeft, ArrowRight, ChevronRight, Phone, Star, Wrench } from 'lucide-react';
import Link from 'next/link';
import { useRouter } from 'next/router';
import { useEffect, useState } from 'react';

import { getServiceData } from '../../lib/services.js';
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <Link href="/services" className="mt-6 inline-block bg-green-500 text-white px-6 py-3 rounded-full">
            Return to Services
          </Link>
        </div>
      </div>
      ...
      <div className="min-h-screen pt-10">
        ...
        <section className="relative pt-24 pb-20 overflow-hidden">
          ...
          <div className="container mx-auto px-6 lg:px-8 relative z-10">
            <div className="mb-8">
              <Link href="/services" className="inline-flex items-center text-gray-600 hover:text-green-500 transition-colors duration-300">
              ...
              <div className="lg:col-span-1">
                ...
                <div className="bg-white rounded-xl shadow-md p-6 mb-8 sticky top-24">
                  ...
                  <div className="border-t border-gray-200 pt-6">
                    ...
                    <p className="text-gray-600 mb-4">We provide this service across all major regions of Ghana, with specialized teams in Accra, Kumasi, and Takoradi.</p>
                    ...
                    {service.relatedServices && service.relatedServices.map((relatedServiceId, index) => (
                      ...
                      >
                        ...
                        <div className="ml-auto">
                          <ArrowRight className="w-4 h-4 text-gray-400 group-hover:text-green-500 transition-colors duration-300" />
                        </div>
                      </Link>
                    ))}
                  </div>
