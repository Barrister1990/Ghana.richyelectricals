...
export default function Gallery() {
  ...
  return (
    <>
    <SEOHead 
  title="Our Projects | Richyelectricals GH - Electrical & Solar Installations"
  description="View our completed electrical, generator, and solar projects across Ghana. Richyelectricals GH delivers reliable solutions for homes and businesses."
  canonicalUrl="https://www.richyelectricalsgh.com/projects"
/>
    ...
    <div className="min-h-screen">
      ...
      {/* Hero Section */}
      <section className="relative w-full h-80 md:h-96 flex items-center overflow-hidden pt-16">
                  ...
                  <div className="p-6 flex-grow">
                    ...
                    <div className="mt-auto">
                      <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        onClick={() => openModal(item)}
                        className="text-green-500 font-medium hover:text-green-600 flex items-center transition-colors"
                      >
                        View Full Size
            ...
            >
              <div className="bg-gray-100 rounded-xl p-8 max-w-lg mx-auto">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={() => setFilter('all')}
                  className="bg-green-500 hover:bg-green-600 text-white font-medium py-3 px-8 rounded-full shadow-lg transition-all duration-300"
                >
                  View All Images
                </motion.button>
              </div>
