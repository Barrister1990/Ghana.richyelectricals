...
import { Calendar, ChevronLeft, ChevronRight, Filter, MapPin, Play, X } from 'lucide-react';
            ...
            >
              <div className="bg-gray-100 rounded-xl p-8 max-w-lg mx-auto">
                ...
                <p className="text-gray-600 mb-6">
                  We couldn&rsquo;t find any images matching your selected filter. Please try a different category.
                </p>
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
        ...
        {modalOpen && selectedItem && (
          ...
          >
            ...
            <motion.div 
              ...
              className="relative bg-white rounded-xl shadow-2xl max-w-6xl w-full mx-auto overflow-hidden z-10"
            >
              {/* Close Button */}
              <button 
                onClick={closeModal}
              ...
              <div className="flex flex-col md:flex-row">
                {/* Media Container */}
                <div className="w-full md:w-3/5 bg-gray-900 relative">
                ...
                <div className="w-full md:w-2/5 p-6 md:p-8 flex flex-col">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-3">{selectedItem.title}</h3>
                  ...
                  <div className="mb-6">
                    ...
                    <div className="flex justify-between text-sm text-gray-500 mb-2">
                      <span>Client:</span>
                      <span className="font-medium text-gray-700">{selectedItem.client}</span>
                    </div>
                  </div>
                  
                  <div className="mt-auto">
                    <h4 className="text-lg font-medium text-gray-900 mb-3">Interested in a similar project?</h4>
                    <div className="flex flex-col space-y-3">
                      <motion.div
                        whileHover={{ scale: 1.02 }}
                        whileTap={{ scale: 0.98 }}
                      >
                        <Link href="/contact" className="inline-block w-full bg-orange-500 hover:bg-orange-600 text-white font-medium py-3 px-6 rounded-lg text-center transition-all duration-300">
                          Request a Quote
                        </Link>
                      </motion.div>
                      <motion.div
                        ...
                        whileTap={{ scale: 0.98 }}
                      >
                        <Link href="/services" className="inline-flex items-center justify-center w-full bg-gray-100 hover:bg-gray-200 text-gray-800 font-medium py-3 px-6 rounded-lg text-center transition-all duration-300">
